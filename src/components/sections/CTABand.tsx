...
export function CTABand({
  title = "When communities thrive, wildlife thrives.",
  body = "Help communities develop sustainable livelihoods, create enterprises and build practical solutions for living alongside wildlife.",
  ...
  return (
    <section className="relative isolate overflow-hidden bg-earth-800 py-16 text-sand-50 sm:py-20">
      <div aria-hidden="true" className="absolute inset-0 opacity-25">
        ...
        >
          <path
            d="M0 30 Q 25 18 50 27 T 100 20 V40 H0Z"
            fill="var(--color-forest-700)"
          />
          <path
            d="M0 36 Q 35 26 65 34 T 100 30 V40 H0Z"
